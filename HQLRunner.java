...
public class HQLRunner extends JFrame implements ActionListener, ListSelectionListener {
    ...
    // all components
    private JTextArea txtHQL = new JTextArea(13, 100);
    ...
    public void runHQL(String strHQL) {
        ...
        this.txtGeneratedSQL.setWrapStyleWord(true);
        this.txtGeneratedSQL.setLineWrap(true);
    ...
    public String toSql(String hqlQueryText) {
        ...
        if (hqlQueryText != null && hqlQueryText.trim().length() > 0) {
            ...
            final QueryTranslator translator = translatorFactory.createQueryTranslator(
                    hqlQueryText, hqlQueryText, java.util.Collections.EMPTY_MAP, factory, null
            );
